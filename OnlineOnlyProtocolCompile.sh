...
echo "Starting online benchmarking protocol compilation..."
...
case "$1" in
    "S")
        ...
        ./compile.py -P 140737488355333 MPC-AS-SUM-$key_param 1
        ;;
    "V")
        echo "Starting VAR compilation..."
        ./compile.py -P 140737488355333 MPC-AS-VAR-$key_param 1
        ;;
    "F")
        echo "Starting FRQ compilation..."
        ./compile.py -P 140737488355333 MPC-AS-FRQ-$key_param 1
        ;;
    "L")
        echo "Starting LR compilation..."
        ./compile.py -P 140737488355333 MPC-AS-LR-$key_param 1
        ;;
    "M")
        echo "Starting MAX compilation..."
        ./compile.py -P 140737488355333 MPC-AS-MAX-$key_param 1
        ;;
    *)
